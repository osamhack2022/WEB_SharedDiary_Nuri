        ...
        <div className='Login'>
            <div className="Login-container">
                <div className='logo'>
                    ...
                    <p style={{color: '#808080'}}><strong>누리, 사색을 공유하다</strong></p>
                </div>
                <div className='login-form'>
                    <p className='input'><input type="text" name="email" value={email} onChange={onChange} placeholder="email"/></p>
                    <p className='input'><input type="password" name="password" value={password} onChange={onChange} placeholder="password"/></p>   
